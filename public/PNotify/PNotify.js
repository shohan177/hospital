    ...
    PNotify = function() {
        ...
        var i = {
            runModules: function(t) {
                if ("init" === t) {
                    for (var e in h.modules)
                        if (h.modules.hasOwnProperty(e) && "function" == typeof h.modules[e].init) {
            ...
            close: function(t) {
                ...
                if ("closing" !== i && "closed" !== i) {
                    ...
                    return n && clearTimeout && (clearTimeout(n), this.set({
                        ...
                        if (e.set({
                                _state: "closed"
                            }), e.runModules("afterClose"), e.queuePosition(), e.get().remove && e.refs.elem.parentNode.removeChild(e.refs.elem), e.runModules("beforeDestroy"), e.get().destroy && null !== h.notices) {
                            var t = h.notices.indexOf(e); - 1 !== t && h.notices.splice(t, 1)
                        }
            ...
            position: function() {
                ...
                if (t) {
                    ...
                    }(t)), e.getBoundingClientRect(), t.animation && this.set({
                        _moveClass: "ui-pnotify-move"
                    });
                    var i = t.context === document.body ? window.innerHeight : t.context.scrollHeight,
                        n = t.context === document.body ? window.innerWidth : t.context.scrollWidth,
                        o = void 0;
                    if (t.dir1) {
                        o = {
                            down: "top",
                    ...
                    if (t.dir1) switch ("number" == typeof t.nextpos1 && (e.style[o] = t.nextpos1 + "px", t.animation || e.style[o]), t.dir1) {
                        ...
                        var d = n / 2 - e.offsetWidth / 2,
                            p = i / 2 - e.offsetHeight / 2;
            ...
            ! function(t, e) {
                ...
                (function() {
                    ...
                    this.on("mouseenter", function(t) {
                        ...
                        e.get().hide && e.get().mouseReset && "out" !== e.get()._animating && e.queueClose(), h.positionAll()
                    });
                    var t = this.get().stack;
                    t && "top" === t.push ? h.notices.splice(0, 0, this) : h.notices.push(this), this.runModules("init"), this.set({
                        _state: "closed"
        ...
        return a(o.prototype, {
            ...
            if (!1 !== t)
                for (var e = 0; e < h.notices.length; e++) h.notices[e].close && h.notices[e].get().stack === t && h.notices[e].close(!1)
