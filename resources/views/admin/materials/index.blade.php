            ...
            <div class="box box-success">
                ...
                <div class="box-header with-border">
	                ...
	                <div class="box-tools pull-right">
	                    <a href="{{route('materials.create')}}" class="btn btn-xs btn-success pull-left text-white" title="Add New"><i class="fa fa-plus"></i> <span class="text-capitalize">Add Materials</span></a>
	                </div>
	            </div>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                	...
                                	<a href="{{route('materials.show', $material->id)}}" class="btn btn-xs btn-success action-view" title="View"><i class="fa fa-eye"></i></a>

                                	<a href="{{route('materials.edit', $material->id)}}" class="btn btn-xs btn-primary action-pencil" title="Edit"><i class="fa fa-pencil"></i></a>
