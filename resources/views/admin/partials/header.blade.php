<header class="main-header">
    ...
    <a href="index2.html" class="logo">
        ...
        <span class="logo-lg"><b>Admin</b>DESH</span>
    </a>
            ...
            <ul class="nav navbar-nav ml-auto">
                                ...
                                <li>
                                    ...
                                    <a href="#">
                                        <div class="pull-left">
                                            ...
                                            @else
                                            <img class="profile-user-img img-responsive img-circle" src="{{asset('admin_assets/lte/dist/img/user1-128x128.jpg')}}" alt="User profile picture" />
                ...
                <li class="nav-item dropdown user user-menu">
                    ...
                    <a href="#" data-toggle="dropdown" class="nav-link dropdown-toggle" aria-expanded="false">
                        ...
                        @else
                        <img class="user-image" src="{{asset('admin_assets/defult_media/defult.png')}}" alt="User profile picture" />
                        @endif
