<head>
    ...
    <link rel="apple-touch-icon" sizes="152x152" href="{{ asset('frontend_assets/images/apple-touch-icon-152x152.png') }}">
    <link rel="apple-touch-icon" sizes="120x120" href="{{ asset('frontend_assets/images/apple-touch-icon-120x120.png') }}">
    <link rel="apple-touch-icon" sizes="76x76" href="{{ asset('frontend_assets/images/apple-touch-icon-76x76.png') }}">
