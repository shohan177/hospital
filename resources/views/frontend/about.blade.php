				...
				<div class="container">
					...
					<div class="top-row mb-80">
						...
						<div class="col-lg-6">
							<div class="info-4-img text-center wow fadeInUp" data-wow-delay="0.6s">
								<img class="img-fluid" src="frontend_assets/images/chief_doctor_700x800.jpg" alt="info-image">
							</div>
						</div>
					...
					<div class="bottom-row">
						<div class="row d-flex align-items-center">
							...
							<div class="col-lg-6">
								<div class="info-4-img text-center wow fadeInUp" data-wow-delay="0.6s">
									<img class="img-fluid" src="frontend_assets/images/emergency_help_700x800.jpg" alt="info-image">
								</div>
							</div>
			 			...
			 			<div class="col-lg-6">
			 				<div class="video-preview mb-40 text-center wow fadeInUp" data-wow-delay="0.6s">
								...
								<a class="video-popup1" href="https://www.youtube.com/embed/SZEflIVnhH8">
									...
									<!-- Preview -->
									<img class="img-fluid" src="frontend_assets/images/video-1.png" alt="video-photo" />
					...
					<div class="row">
						<div class="col-lg-10 offset-lg-1">
							<div class="banner-5-img wow fadeInUp" data-wow-delay="0.4s">
								<img class="img-fluid" src="frontend_assets/images/image-07.png" alt="banner-image" />
							</div>
						</div>
					</div>
