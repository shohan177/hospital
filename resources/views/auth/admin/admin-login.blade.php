...
<html>
    ...
    <head>
        ...
        <!-- iCheck -->
        <link rel="stylesheet" href="{{asset('admin_assets/lte/plugins/iCheck/square/blue.css')}}" />
    ...
    <body class="hold-transition login-page">
            ...
            <div class="login-box-body">
                ...
                <form method="POST" action="{{ route('admin.login.submit') }}">
                    ...
                    <div class="form-group has-feedback">
                        <input type="email" name="email" class="form-control @error('email') is-invalid @enderror" value="{{ old('email') }}" required="" placeholder="Email" autofocus />
                        @error('email')
        ...
        <!-- iCheck -->
        <script src="{{asset('admin_assets/lte/plugins/iCheck/icheck.min.js')}}"></script>
        <script>
            $(function () {
                $("input").iCheck({
